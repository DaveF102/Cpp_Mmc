...
void ChatLogic::LoadAnswerGraphFromFile(std::string filename)
{
    ...
    // add local instance
    ChatBot instanceChatBot = ChatBot("../images/chatbot.png");
    instanceChatBot.SetChatLogicHandle(this);
    instanceChatBot.SetRootNode(rootNode);
    _chatBot = &instanceChatBot;
    rootNode->MoveChatbotHere(std::move(instanceChatBot));
}
